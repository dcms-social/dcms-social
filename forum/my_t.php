...
$k_post = mysql_result(mysql_query("SELECT COUNT(*) FROM `forum_t`  WHERE `id_user` = '$user[id]'"),0);
...
$q = mysql_query("SELECT * FROM `forum_t` WHERE `id_user` = '$user[id]' ORDER BY `time` DESC  LIMIT $start, $set[p_str]");
